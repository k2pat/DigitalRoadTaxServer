...
module.exports = async function (req, res) {
    try {
        ...
        result = await vehicleModel.update(transaction.vehicle);
        ...
        const registrationToken = (transaction.device_token != null) ? transaction.device_token : await redis.get(transaction.u_id);
