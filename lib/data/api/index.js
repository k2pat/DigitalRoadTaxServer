...
router.post('/proof/get', (req, res) => handleRequest(req, res, proofModel.get));
router.post('/proof/create', (req, res) => handleRequest(req, res, proofModel.create));
router.post('/proof/update', (req, res) => handleRequest(req, res, proofModel.update));
